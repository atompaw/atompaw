...
CONTAINS
  ...
  SUBROUTINE LDAGGA_SCF(scftype,lotsofoutput,Gridin,Orbitin,Potin,FCin,SCFin)
    ...
    WRITE(STD_OUT,*) 'start ldagga_scf ', scftype, frozencorecalculation; call flush(STD_OUT)
...
&       tau=Orbit%tau,vtau=Pot%vtau)
    ...
    WRITE(STD_OUT,*) 'Exchange-Correlation          :  ',SCF%eexc  
    ...
    If(.NOT.frozencorecalculation) WRITE(STD_OUT,*) '    Total   (DC form)        :  ',&
